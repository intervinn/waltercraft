...
<div class="flex flex-col items-center lg:mx-auto lg:w-[85vw] mt-10">
    {#key season}
        <div in:fade={{duration:500}} class="w-full flex flex-col justify-center lg:flex-row">
            ...
            <img loading="lazy" src={season.image} alt={season.name} class="object-cover aspect-video h-96 rounded-2xl" id="season" />
        </div>
    {/key}
